...
const seasonalItems = [
  {
    ...
    description:
      "Dark chocolate infused with warming spices and crystallized ginger",
...
export function SeasonalSection() {
  return (
    <section className="py-24 bg-[#321b21] text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Like rare astronomical events, our seasonal collections appear for
            brief, magical moments. Each edition captures the essence of its
            time, never to be repeated exactly the same way again.
          </p>
        </motion.div>
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {seasonalItems.map((item, index) => (
              ...
              >
                <div className="bg-[#3F1E27] border border-gray-700 group-hover:border-gray-500 transition-all duration-300 p-8 relative overflow-hidden">
                  ...
                  <div className="space-y-4">
                    <div>
                      <h3 className="text-xl mb-2 group-hover:text-gray-300 transition-colors">
                        {item.name}
                      </h3>
        ...
        >
          ...
          <p className="text-gray-500 text-sm mt-3">
            Get early access to all seasonal releases and limited editions
          </p>
        </motion.div>
      </div>
    </section>
